...
import { DiscountService, __discountInternals } from '../src/ad/discount.service.js'
import { DiscountTokenRepository } from '../src/repo/discountToken.repository.js'
...
const baseToken = {
  ...
  redeemedRideId: null as string | null,
  createdAt: new Date()
}
...
describe('DiscountService', () => {
  ...
  test('mintToken_generatesActiveToken', async () => {
    ...
    const expiresArg = mintSpy.mock.calls[0][0].expiresAt as Date
