...
import { QuoteStore } from '../src/workbench/quoteStore.js'
import { getMemoryDb, initMemoryDb, resetMemoryDb } from '../src/workbench/memoryDb.js'
import { DiscountService } from '../src/ad/discount.service.js'
import { PricingService } from '../src/shared/pricing.service.js'
...
describe('RideService (Jest)', () => {
  ...
  test('createRide_appliesDiscountAndRedeemsToken', async () => {
    ...
    const pricingSpy = jest.spyOn(PricingService, 'applyDiscount').mockReturnValue(discountValue as any)
